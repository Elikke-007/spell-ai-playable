...
export default class Main extends cc.Component {
  ...
  start() {
    ...
    this.downloadBtn.on(cc.Node.EventType.TOUCH_END, this._onClickDownload.bind(this))
    this.downloadBtn2.on(cc.Node.EventType.TOUCH_END, this._onClickDownload.bind(this))
  }
  onDestroy(): void {
